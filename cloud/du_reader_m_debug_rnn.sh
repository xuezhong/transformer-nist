...
--k8s-memory 100Gi \
--k8s-ps-memory 20Gi \
--job-name dr_b${batch_size}_debugrnn_${optim}_dev${dev_interval}_${wd}_8c \
...
--image-addr "registry.baidu.com/qiuxuezhong/fluid_gpu:seq_reverse_c020f36efd5263a9b5e365579e6d7a9e14544264"
